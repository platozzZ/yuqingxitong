		...
		<block v-if="!$slots.default && !$slots.$default">
			<scroll-view scroll-y="true" :style="{
				...
				<view class="u-dropdown-item__options">
					<u-cell-group>
						<u-cell-item @click="cellClick(item.value,index)" :arrow="false" :title="item.label" v-for="(item, index) in options"
	...
	export default {
		...
		data() {
			return {
				...
				activeColor: '#cc0000', // 激活时左边文字和右边对勾图标的颜色
